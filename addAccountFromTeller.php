...
<body>
    ...
    <div class="form-container" id="content">
        <!-- Back Button -->
        <a href="userAccountsFromTeller.php?user_id=<?php echo $user_id;?>" class="back-button">
        ...
        <form method="POST" action="createAccountFromTellerBack.php?user_id=<?php echo $user_id; ?>">
            <div class="mb-3">

...
<body>
    ...
    <form class="row" id="signInForm" method="POST" action="changePasswordManagerBack.php?user_id=<?php echo htmlspecialchars($user_id); ?>">
        <a href="managerProfile.php" style="text-decoration: none; margin-bottom: 20px;">

...
<body>
    ...
    <form class="row" id="signInForm" method="POST" action="changePasswordTellerBack.php?user_id=<?php echo htmlspecialchars($user_id); ?>">
        <a href="tellerProfile.php" style="text-decoration: none; margin-bottom: 20px;">

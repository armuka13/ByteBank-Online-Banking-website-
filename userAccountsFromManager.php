    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <form class="d-flex" method="GET" action="">
                ...
                <input class="form-control me-2 search_class form-input" type="search" name="search" placeholder="Search by account number, type, or currency..." aria-label="Search" value="<?php echo htmlspecialchars($search); ?>">
                    ...
                    <?php while ($account = $accounts->fetch_assoc()): ?>
                        <tr class="accTr">
                            ...
                            <td style="text-align: center;">
                                <a href="deleteAccount.php?user_id=<?php echo $user['id']; ?>&acc_id=<?php echo $account['id']; ?>">

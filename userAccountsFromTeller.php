...
<body>
    <div class="container">
        <!-- Back Button -->
        <a href="manageUsersTeller.php" class="back-button" style="width: 100px;">
        ...
        <form method="POST" action="updateAccountTeller.php?user_id=<?php echo $user_id; ?>">
            <input type="hidden" name="user_id" value="<?php echo $user_id; ?>">
            <table>
                <thead>
                    <tr>
                 ...
                 <tbody>
                    <tr>
                        <td colspan="6" style="text-align: center;" class="add" onclick="window.location.href='addAccountFromManager.php?user_id=<?php echo $user_id; ?>'">
                    ...
                    <?php if ($accounts->num_rows > 0): ?>
                        <?php while ($account = $accounts->fetch_assoc()): ?>
                            <tr class="accTr">
                                ...
                                <td>
                                    <input type="number" name="valueToUpdate[<?php echo $account['id']; ?>]" class="dataField" value="0" step="0.01">
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" style="text-align: center;">No accounts available</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>

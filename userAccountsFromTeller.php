    ...
    <div class="container">
        ...
        <form method="POST" action="updateAccountTeller.php?user_id=<?php echo $user_id; ?>">
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        <td colspan="5" style="text-align: center;" class="add" onclick="window.location.href='addAccountFromTeller.php?user_id=<?php echo $user_id; ?>'">
                        ...
                        <?php while ($account = $accounts->fetch_assoc()): ?>
                            <tr class="accTr">
                                ...
                                <td style="text-align: center;">
                                    <a href="deleteAccountTeller.php?user_id=<?php echo $user_id; ?>&acc_id=<?php echo $account['id']; ?>">
